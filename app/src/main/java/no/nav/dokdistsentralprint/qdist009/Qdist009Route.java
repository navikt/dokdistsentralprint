...
public class Qdist009Route extends SpringRouteBuilder {
	...
	private static final String SFTP_FILE_CONFIG = "binary=true&fileName=${exchangeProperty." + PROPERTY_BESTILLINGS_ID + "}" + SFTP_FILETYPE + "&jschLoggingLevel=TRACE";
	...
	private static final String SFTP_SERVER = "sftp://{{sftp.url}}:{{sftp.port}}/{{sftp.remoteFilePath}}?username=srvdokdistsentralp&***passord=gammelt_passord***;
