...
Mer informasjon om hvordan appen fungerer finner du på [Confluence-siden for dokdistsentralprint](https://confluence.adeo.no/display/BOA/dokdistsentralprint).

### Deploy av ny versjon
